...
SECRET_KEY = 'django-insecure-m3y87y4myn)58-m^zmtat$ek2mya*%2qtkid151))0ai174%p2'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Production EC2 instance configuration
# EC2 IPs: 16.171.199.158 (old), 13.60.204.193 (new)
import os
ALLOWED_HOSTS = [
    '16.171.199.158',
    '13.60.204.193',
...
# ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '13.60.204.193,16.171.199.158,localhost').split(',')
